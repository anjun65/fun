        ...
        <section class="relative mx-auto flex max-w-7xl flex-col items-center px-4 pt-32 sm:px-6 lg:px-8">
            ...
            <div id="default-tab-content">
              <div class="hidden p-4" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                  ...
                  <div class="grid grid-cols-1 gap-y-2 sm:grid-cols-2 sm:gap-x-2 sm:gap-y-2 lg:gap-x-2 xl:grid-cols-4">
              ...
              <div class="hidden p-4 rounded-lg bg-gray-50 " id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                <div class="grid grid-cols-1 gap-y-2 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-10 lg:gap-x-2 xl:grid-cols-4">
