      ...
      <div class="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-0">
        <div class="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
          ...
          <div class="mt-6 md:mt-0 md:ml-4 lg:mt-6 lg:ml-0">
            <h3 class="text-base font-medium text-gray-900">High Quality Materials</h3>
          </div>
        </div>
        ...
        <div class="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
          ...
          <div class="mt-6 md:mt-0 md:ml-4 lg:mt-6 lg:ml-0">
            <h3 class="text-base font-medium text-gray-900">Custom Size</h3>
            </div>
        </div>
        ...
        <div class="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
          ...
          <div class="mt-6 md:mt-0 md:ml-4 lg:mt-6 lg:ml-0">
            <h3 class="text-base font-medium text-gray-900">Exclusive Design</h3>
            </div>
        </div>
        ...
        <div class="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
          ...
          <div class="mt-6 md:mt-0 md:ml-4 lg:mt-6 lg:ml-0">
            <h3 class="text-base font-medium text-gray-900">Customer Service Friendly</h3>
          </div>
        </div>
      </div>
    </div>
