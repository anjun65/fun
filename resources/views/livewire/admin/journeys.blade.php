<div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6">
    <div class="py-4 space-y-4">
        ...
        <div class=" lg:mb-0">
            <h3 class="text-2xl font-bold text-gray-900">Our Journey</h3>
        </div>
        ...
        <div class="flex-col space-y-4 py-4">
            <x-table>
                <x-slot name="head">
                    ...
                    <x-table.heading sortable multi-column wire:click="sortBy('year')" :direction="$sorts['year'] ?? null">Tahun</x-table.heading>
            ...
            <x-slot name="content">
                <div class="grid grid-cols-6 gap-6 py-4">
                        <div class="col-span-6">
                            ...
                            <input type="number" name="year" wire:model.lazy="editing.year" id="year" class="block p-2.5 w-full border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Fill the text" required>
                        </div>
