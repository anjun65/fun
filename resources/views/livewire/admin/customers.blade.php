<div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6">
    <div class="py-4 space-y-4">
        ...
        <div class=" lg:mb-0">
            <h3 class="text-2xl font-bold text-gray-900">Customer</h3>
        </div>
        ...
        <div class="flex-col space-y-4 py-4">
            <x-table>
                <x-slot name="head">
                    ...
                    email
                    password
                    <x-table.heading sortable multi-column wire:click="sortBy('name')" :direction="$sorts['name'] ?? null">Customer</x-table.heading>
                    <x-table.heading sortable multi-column wire:click="sortBy('nama')" :direction="$sorts['nama'] ?? null">Asal Daerah</x-table.heading>
                    <x-table.heading sortable multi-column wire:click="sortBy('nama')" :direction="$sorts['nama'] ?? null">No Telpon</x-table.heading>
                    <x-table.heading sortable multi-column wire:click="sortBy('nama')" :direction="$sorts['nama'] ?? null">Email</x-table.heading>
                    <x-table.heading sortable multi-column wire:click="sortBy('nama')" :direction="$sorts['nama'] ?? null">Total Orderan</x-table.heading>
                    <x-table.heading sortable multi-column wire:click="sortBy('nama')" :direction="$sorts['nama'] ?? null">Total Transaksi</x-table.heading>
            ...
            <x-slot name="content">
                <div class="grid grid-cols-6 gap-6 py-4">
                        <div class="col-span-6">
                            ...
                            <input type="text" name="nama" wire:model.lazy="editing.nama" id="nama" class="block p-2.5 w-full border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Fill the text" required>
                        </div>

                        <div class="col-span-6">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Tempat</label>
                            <input type="text" name="tempat" wire:model.lazy="editing.tempat" id="tempat" class="block p-2.5 w-full border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Fill the text" required>
                        </div>
                        ...
                        <div class="col-span-6">
                            ...
                            <x-datepicker wire:model="editing.tanggal_lahir" id="tanggal_lahir" placeholder="Tanggal Lahir"></x-datepicker>
                    
                        </div>

                        <div class="col-span-6">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Pendidikan Terakhir</label>
                            <input type="text" name="pendidikan" wire:model.lazy="editing.pendidikan" id="pendidikan" class="block p-2.5 w-full border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Fill the text" required>
                        </div>
                    </div>
            </x-slot>
