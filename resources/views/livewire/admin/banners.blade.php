<div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6">
    <div class="py-4 space-y-4">
        ...
        <div class=" lg:mb-0">
            <h3 class="text-2xl font-bold text-gray-900">Banner</h3>
        </div>
        ...
        <div class="flex-col space-y-4 py-4">
            <x-table>
                <x-slot name="head">
                    ...
                    <x-table.heading>Call To Action</x-table.heading>
                    <x-table.heading>Deskripsi</x-table.heading>
                    <x-table.heading>Link to Product</x-table.heading>
    ...
    <form wire:submit.prevent="save">
        <x-modal.dialog wire:model.defer="showEditModal">
            <x-slot name="title">Tambah Banner</x-slot>

            <x-slot name="content">
                <div class="grid grid-cols-6 gap-6 py-4">
                        <div class="col-span-6">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Call to Action</label>
                            <input type="text" name="cta" wire:model.lazy="editing.cta" id="cta" class="block p-2.5 w-full border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Fill the text" required>
                        </div>
                        ...
                        <div class="col-span-6">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Link To Product</label>
