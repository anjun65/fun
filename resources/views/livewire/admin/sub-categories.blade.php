<div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6">
    <div class="py-4 space-y-4">
        ...
        <div class=" lg:mb-0">
            <h3 class="text-2xl font-bold text-gray-900">Sub Kategori</h3>
        </div>
        ...
        <div class="flex-col space-y-4 py-4">
            <x-table>
                <x-slot name="head">
                    ...
                    <x-table.heading sortable multi-column wire:click="sortBy('categories_id')" :direction="$sorts['categories_id'] ?? null">Kategori Produk</x-table.heading>
                    <x-table.heading sortable multi-column wire:click="sortBy('name')" :direction="$sorts['name'] ?? null">Sub Kategori Produk</x-table.heading>
    ...
    <form wire:submit.prevent="save">
        <x-modal.dialog wire:model.defer="showEditModal">
            <x-slot name="title">Tambah Sub Kategori</x-slot>
            ...
            <x-slot name="content">
                <div class="grid grid-cols-6 gap-6 py-4">
                        ...
                        <div class="col-span-6">
                            ...
                            <select id="categories_id" name="categories_id" wire:model.lazy="editing.categories_id" class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                        ...
                        <div class="col-span-6">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Sub Kategori</label>
