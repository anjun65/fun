<div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6">
    <div class="py-4 space-y-4">
        ...
        <div class=" lg:mb-0">
            <h3 class="text-2xl font-bold text-gray-900">Profile Brand - Reseller</h3>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div id="dropdown-bulk" class="z-10 hidden w-56 p-3 bg-white rounded-lg shadow">
                    ...
                    <ul class="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                        ...
                        <button type="button" wire:click="createImage" class="block w-full px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900 flex items-center space-x-2" wire:click="$toggle('showDeleteModal')" role="menuitem">
        ...
        <div class="flex-col space-y-4 py-4">
            <x-table>
                <x-slot name="head">
                    ...
                    <x-table.heading sortable multi-column wire:click="sortBy('provinsi')" :direction="$sorts['provinsi'] ?? null">Provinsi</x-table.heading>
                    <x-table.heading sortable multi-column wire:click="sortBy('kota')" :direction="$sorts['kota'] ?? null">Kota</x-table.heading>
                    <x-table.heading sortable multi-column wire:click="sortBy('juara')" :direction="$sorts['juara'] ?? null">Juara</x-table.heading>
            ...
            <x-slot name="content">
                <div class="grid grid-cols-6 gap-6 py-4">
                        <div class="col-span-6">
                            ...
                            <input type="text" name="years" wire:model.lazy="editing.years" id="years" class="block p-2.5 w-full border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Fill the text" required>
                        </div>

                        <div class="col-span-6">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Provinsi</label>
                            <select id="provinsi" name="provinsi" wire:model.lazy="editing.provinsi" class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                        ...
                        <div class="col-span-6">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Kota</label>
                            <select id="kota" name="kota" wire:model.lazy="editing.kota" class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                        ...
                        <div class="col-span-6">
                            <label class="block mb-2 text-sm font-medium text-gray-900">Juara</label>
                            <select id="juara" name="juara" wire:model.lazy="editing.juara" class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                <option value="" selected>Pilih Juara</option>
    ...
    <form wire:submit.prevent="saveGallery">
        <x-modal.dialog wire:model.defer="showImageModal">
            <x-slot name="title">Tambah Gambar</x-slot>
