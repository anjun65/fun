...
use App\Models\ResponsibilityGallery;
...
class Responsibilitys extends Component
{
    ...
    {
        $item = ResponsibilityGallery::findorFail($this->file_id);
        $item->delete();
        $this->file_id = null;
    ...
    public function edit(Responsibility $transaction)
    {
    ...
    public function save()
    {
        ...
        foreach ($this->upload as $upload) {
            ResponsibilityGallery::create([
                'responsibility_id' => $this->editing->id,
    ...
    {
        return view('livewire.admin.responsibilitys', [
            'items' => $this->rows,
        ]);
    }
}
