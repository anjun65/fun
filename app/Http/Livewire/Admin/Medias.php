...
class Medias extends Component
{
    ...
    public function edit(MediaCoverage $transaction)
    {
    ...
    {
        return view('livewire.admin.medias', [
            'items' => $this->rows,
        ]);
    }
}
