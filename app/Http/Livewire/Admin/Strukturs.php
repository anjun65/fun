...
class Strukturs extends Component
{
    ...
    public function edit(Struktur $transaction)
    {
    ...
    {
        return view('livewire.admin.strukturs', [
            'items' => $this->rows,
        ]);
    }
}
